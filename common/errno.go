...
var (
	...
	ErrorTokenFalse         = errors.New("token不正确，请重新登录")
	ErrorExpired            = errors.New("token已过期，请重新登录")
	...
	ErrorFavoriteExist      = errors.New("喜欢已存在")
	...
	ErrorCommentListGet     = errors.New("获取评论列表失败")
)
